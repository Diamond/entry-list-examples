...
/***/ function(module, exports, __webpack_require__) {
	...
	var EntryList = React.createClass({displayName: "EntryList",
	  renderEntry: function(entry) {
	    return (React.createElement(EntryItem, {entry: entry, key: entry, removeEntry: this.props.removeEntry}));
	  },
	  render: function() {
	    return (
	...
	var EntryItem = React.createClass({displayName: "EntryItem",
	  ...
	  render: function() {
	    return (
	      React.createElement("li", {key: this.props.entry}, 
	        this.props.entry, 
	...
	var EntryForm = React.createClass({displayName: "EntryForm",
	  ...
	  render: function() {
	    return (
	      React.createElement("div", null, 
	        React.createElement("input", {type: "text", ref: "entry", onInput: this.updateEntry}), 
	        React.createElement("button", {onClick: this.addEntry}, "Add")
	      )
	    );
	  }
	});
