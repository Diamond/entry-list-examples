...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBarComponent = _vue2.default.extend({
	  template: "<input type=\"text\" placeholder=\"Search\" v-model=\"searchFor\">",
	  props: ['searchFor']
	});

	var AddTodoComponent = _vue2.default.extend({
	...
	var TodoComponent = _vue2.default.extend({
	  ...
	  methods: {
	    removeTodo: function removeTodo() {
	      ...
	      this.todos = this.todos.filter(function (item) {
	        return item.indexOf(_this.todo) === -1;
	      });
	    }
	  }
	});

	var EntryListComponent = _vue2.default.extend({
	  ...
	  computed: {
	    filteredTodos: function filteredTodos() {
	      ...
	      return this.todos.filter(function (item) {
	        return item.indexOf(_this2.searchFor) !== -1;
	      });
	    }
	  }
	});

	_vue2.default.component("entry-list", EntryListComponent);
